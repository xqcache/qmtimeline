#include "qmtimelineranger.h"
#include "ui_qmtimelineranger.h"
...
QmTimelineRanger::QmTimelineRanger(QWidget* parent)
    : QWidget(parent)
    , ui_(new Ui::QmTimelineRanger)
    , d_(new QmTimelineRangerPrivate)
{
    initUi();
    setupSignals();
}

QmTimelineRanger::~QmTimelineRanger() noexcept
{
    delete ui_;
    delete d_;
}

void QmTimelineRanger::initUi()
{
    ui_->setupUi(this);
...
{
    connect(ui_->slider, &QmTimelineRangeSlider::frameRangeChanged, this, [this](qint64 minimum, qint64 maximum) {
...
void QmTimelineRanger::setFrameFormat(QmFrameFormat frame_fmt)
{
    ui_->slider->setFrameFormat(frame_fmt);

    if (frame_fmt == QmFrameFormat::Frame) {
        ...
        if (frame_fmt == QmFrameFormat::TimeCode) {
...
void QmTimelineRanger::setFps(double fps)
{
...
void QmTimelineRanger::setFrameMinimum(qint64 minimum)
{
    {
...
void QmTimelineRanger::setFrameMaximum(qint64 maximum)
{
    {
        QSignalBlocker blocker(ui_->slider);
...
QmTimelineRangeSlider* QmTimelineRanger::slider() const
{
    return ui_->slider;
}

double QmTimelineRanger::fps() const
{
